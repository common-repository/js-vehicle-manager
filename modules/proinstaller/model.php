...
class JSJOBSproinstallerModel {
    ...
    function getServerValidate() {
        ...
        jsvehiclemanager::$_data['curlversion'] = $curlversion;
        jsvehiclemanager::$_data['gdlib'] = $gd_lib;
        jsvehiclemanager::$_data['ziplib'] = $zip_lib;
    }
    ...
    function getConfiguration() {
        ...
        if (is_plugin_active('js-jobs/js-jobs.php')) {
            ...
            $config = jsvehiclemanager::$_db->get_results($query);
            foreach ($config as $conf) {
                jsvehiclemanager::$_configuration[$conf->configname] = $conf->configvalue;
            }
            jsvehiclemanager::$_configuration['config_count'] = COUNT($config);
        }
    }
    ...
    function getStepTwoValidate() {
        ...
        $return['dir'] = substr(sprintf('%o', fileperms(jsvehiclemanager::$_path)), -3);
        ...
        jsvehiclemanager::$_db->query($query);
        $return['create_table'] = 1;

        if (jsvehiclemanager::$_db->last_error != null) {
        ...
        if ($return['dir'] >= 755 && $return['tmpdir'] >= 755) {
            ...
            $fp = fopen(jsvehiclemanager::$_path . 'logo.png', 'w+');
            ...
            if (file_exists(jsvehiclemanager::$_path . 'logo.png')) {
            ...
            $return['file_downloaded'] = 0;
        jsvehiclemanager::$_data['step2'] = $return;
    }
    ...
    function getmyversionlist() {
        ...
        $post_data['count'] = jsvehiclemanager::$_configuration['config_count'];
